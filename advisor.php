...
if($_SESSION['signed_in'] == false | $_SESSION['user_status'] != true){
	...
	<table border="1" style="width 100%" align="center">
		...
		<tr>
			<th>Q: How do I get cleared for registration</th>
			<th>A: Your advisor needs to clear you for your registration time, 
			some advisors will automatically clear their students, most will 
			require a scheduled meeting beforehand </th>
		</tr>
		<tr>
			...
			<th>A: You can ask your advisor for a form of required classes and credits and
			    You can also check in various places on myHaven. Your advisor should also be 
			    working with you and answer any questions you may have.</th>
		</tr>
		<tr>
		...
		<tr>
			<th>Q: what is the contact information for the registrar office?</th>
