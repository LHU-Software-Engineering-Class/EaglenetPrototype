						...
						<td class="alt2">
							<div class="smallfont" align="left">
								...
								<span style="white-space:nowrap">
									...
									<a href="" style="white-space:nowrap" title="Go to first unread post"> //create select statement that finds the most recent post in each thread and use the post ID to create a link to it <strong>POST TITLE</strong></a></span> //select post content from that query and concat to 15 chars with … at end

								</div>
								<div style="white-space:nowrap">
									by <a href="">dkh1058</a> //select and display the user who posted the latest post from that query
								</div>
								<div align="right" style="white-space:nowrap">
								08-29-2014 <span class="time">03:26 PM</span>//select and display the time the latest post was posted

									<a href=""><img class="inlineimg" src="images/lastpost.gif" alt="Go to last post" border="0" title="Go to last post">
									</a>//same link as the go to first unread post
								</div>
							</div>
						</td>
						<td class="alt1">2
						</td> //count the number of posts in that forum
						<td class="alt2"><span style="float:right">
							<a href="create_topic.php"><img src="images/smallnewtopic.gif" alt="" border="0">
							</a>
							</span>14
						</td> //count the number of threads in that forum
					</tr>
				</tbody>';
			}
		}
